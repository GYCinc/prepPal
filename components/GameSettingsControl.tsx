    ...
    <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-[#1a1b23] px-8 py-6 rounded-3xl border-l-8 border-[#EF6035] flex flex-col justify-center shadow-2xl relative overflow-hidden">
            <div className="relative z-10 flex justify-between items-end mb-4">
                  <div>
                    <h3 className="text-[#EF6035] text-2xl font-black uppercase tracking-wide font-display drop-shadow-md">Difficulty</h3>
            ...
            <div className="relative z-10 flex items-center gap-4">
                <span className="text-base font-bold text-white uppercase tracking-wide drop-shadow-sm">1</span>
                <input
                ...
                />
                <span className="text-base font-bold text-white uppercase tracking-wide drop-shadow-sm">10</span>
            </div>
        ...
        <div className="bg-[#1a1b23] px-8 py-6 rounded-3xl border-l-8 border-purple-500 flex flex-col justify-center shadow-2xl relative overflow-hidden">
            <div className="relative z-10 flex justify-between items-end mb-4">
                  <div>
                    <h3 className="text-purple-400 text-2xl font-black uppercase tracking-wide font-display drop-shadow-md">Tone</h3>
            ...
            <div className="relative z-10 flex items-center gap-4">
                <span className="text-base font-bold text-white uppercase tracking-wide drop-shadow-sm">Conservative</span>
                <input
                ...
                />
                <span className="text-base font-bold text-white uppercase tracking-wide drop-shadow-sm">Witty</span>
            </div>
            {/* Subtle background glow */}
